...
@Component({
  ...
  template: `
    <app-auth-shell heading="Start proving your skills." subheading="Free to join — take your first AI interview in minutes.">
      @if (!registered()) {
        <h1>Create your DevMentor account</h1>
        <p class="lede">Already have one? <a routerLink="/auth/login">Log in</a> instead.</p>
        ...
        <p class="success">Account created. We've sent a confirmation link to your email — open it before logging in.</p>
        <div class="links">
